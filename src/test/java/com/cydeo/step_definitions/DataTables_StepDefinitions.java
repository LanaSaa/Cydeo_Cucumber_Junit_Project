...
public class DataTables_StepDefinitions {
    ...
    public void user_should_see_the_following_list(List<String> pets) {
    ...
    public void user_should_see_below_info_in_month_dropdown(List<String> expectedMonths) {
        Assert.assertEquals(expectedMonths,BrowserUtils.dropdownOptions_as_STRING(dropdownsPage.monthDropdown));
    }
}
